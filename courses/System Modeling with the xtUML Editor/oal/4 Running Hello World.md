In this lesson you will learn how to run the "Hello, World" in BridgePoint's xtUML eXecute (Verifier).  Note that xtUML eXecute is not part of the xtUML Editor application.

<iframe src="//www.youtube.com/embed/OC-hASZobx4?rel=0;start=8;end=105" width="640" height="360" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
