Here the core xtUML data types (boolean, integer, real and string) are demonstrated.

<iframe src="//www.youtube.com/embed/ZSFT8-2PEsg?rel=0;start=9;end=208" width="640" height="360" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
