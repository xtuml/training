In this lesson we demonstrate how to send a message from one component to another through an interface message.

<iframe src="//www.youtube.com/embed/7Qb3T9SDJsQ?rel=0" width="640" height="360" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
