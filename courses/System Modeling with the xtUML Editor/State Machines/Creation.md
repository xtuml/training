...
*   Watching this video will teach you how to create new state machines.  It will take you through the steps of creating states, transitions and events.  Additionally, you will learn how to configure the behavior of the state machine.
