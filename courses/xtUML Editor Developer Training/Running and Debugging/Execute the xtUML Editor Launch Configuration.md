The xtUML Editor Development environment has the ability to self-host a runtime launch of xtUML Editor.  In this lesson, we will learn how to launch xtUML Editor from within xtUML Editor for testing and debugging.
