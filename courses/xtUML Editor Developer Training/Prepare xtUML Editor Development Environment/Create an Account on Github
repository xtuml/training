In this lesson, we show how to create an account on github.com, which is required to be able to access and modify the xtUML Editor source code:

<iframe src="http://www.youtube.com/embed/4jF6Rkh8K-Y?rel=0" width="640" height="360" frameborder="0"></iframe>
