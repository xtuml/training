The xtUML Editor development team encourages developers to make enhancements and fix issues.

When you have completed development on a change that you want to have included in the official xtUML Editor release, you need to submit a pull request that allows the changes to be pulled from your personal repository into the xtuml/editor repository.  This lesson shows how to do this:
<iframe src="http://www.youtube.com/embed/xtAQ9IgbJvA?rel=0" width="640" height="360" frameborder="0"></iframe>
