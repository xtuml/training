When you have made a change to xtUML Editor or created a new plug-in that works in conjunction with xtUML Editor, you may want to include the new functionality in the development environment you actively run.

In this lesson you will learn how to export a modified xtUML Editor plug-in and include it in the local installation:
<iframe src="http://www.youtube.com/embed/lOS1mVa0dGo?rel=0" width="640" height="360" frameborder="0"></iframe>
